...
x_train, y_train = loadlocal_mnist(
        images_path='./emnist/emnist-digits-train-images-idx3-ubyte', 
        labels_path='./emnist/emnist-digits-train-labels-idx1-ubyte')
...
model.fit(x_train, y_train, batch_size=64, epochs=3, shuffle=False, verbose=1)

accuracy = model.evaluate(x=x_test,y=y_test,batch_size=64)
print("Accuracy: ",accuracy[1])

model.save('model_test.h5', overwrite=True)
